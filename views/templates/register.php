...
<section id="inscription-section">
    <div class="formulaire-connexion inscription">
        ...
        <form action="index.php?action=processRegister" method="post">
            ...
            <input type="text" name="pseudo" id="pseudo" required> <!--Permet de rendre obligatoire le champ pseudo-->
            
            <label for="email">Adresse e-mail</label>
            <input type="email" name="email" id="email" required> <!--Permet de rendre obligatoire le champs e-mail-->
            
            <label for="password">Mot de passe</label>
            <input type="password" name="password" id="password" required> <!--Permet de rendre obligatoire le champ mot de passe-->
